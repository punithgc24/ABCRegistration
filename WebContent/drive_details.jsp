...
<body>
	...
	<div class="pos1">
	<p align="center"><strong><font face="verdana"size="5" color="black">DRIVE DETAILS</font></strong></p>
	...
	try
	{
		...
		<tbody id="myTable">
		 <tr>
			...
			<td><a href="del_drive.jsp?time=<%=res.getString("time") %>"><button type="button" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i> Delete</button></a></td>
		    <td><a href="drive_updating.jsp?time=<%=res.getString("time") %>"><button type="button" class="btn btn-primary"><i class="glyphicon glyphicon-refresh"></i>UPDATE</button></a></td>
		 </tr>
		 </tbody>	
